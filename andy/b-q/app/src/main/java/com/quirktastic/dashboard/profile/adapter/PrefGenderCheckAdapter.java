...
public class PrefGenderCheckAdapter extends RecyclerView.Adapter<PrefGenderCheckAdapter.GenderHolder> {

    private List<CheckBoxModel> genderList;
    private Context context;

    public PrefGenderCheckAdapter(Context context, List<CheckBoxModel> list) {
