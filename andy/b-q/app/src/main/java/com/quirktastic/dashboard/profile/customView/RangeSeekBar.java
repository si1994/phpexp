...
package com.quirktastic.dashboard.profile.customView;
...
public class RangeSeekBar<T extends Number> extends android.support.v7.widget.AppCompatImageView {
    ...
    public static final Integer DEFAULT_MINIMUM = 18;
    public static final Integer DEFAULT_MAXIMUM = 65;
