...
public class PrefSocialCheckAdapter extends RecyclerView.Adapter<PrefSocialCheckAdapter.GenderHolder> {

    private List<CheckBoxModel> genderList;
    private Context context;

    public PrefSocialCheckAdapter(Context context, List<CheckBoxModel> list) {
