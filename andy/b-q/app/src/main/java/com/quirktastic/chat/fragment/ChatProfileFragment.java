...
//                }
        ...
        if (userDetailsItem.getEvent() != null && userDetailsItem.getEvent().size() > 0) {
            ...
            if (selectedEvents.size() > 0) {
                ...
                for (int i = 0; i < selectedEvents.size(); i++) {
                    View v = createEventsChip(chatProfileActivity, selectedEvents.get(i));
    ...
    private void setSocialList(UserDetailsItem userDetailsItem) {
        if (userDetailsItem.getSocialLife() != null && userDetailsItem.getSocialLife().size() > 0) {
            rvSocialDrink.setLayoutManager(new GridLayoutManager(chatProfileActivity, 3));
            rvSocialDrink.setAdapter(new SocialLifeListForViewAdapter(chatProfileActivity, userDetailsItem.getSocialLife()));
        }
    }
        ...
        if (interest != null && interest.size() > 0) {
            ...
            if (selectedInterest.size() > 0) {
                for (int i = 0; i < selectedInterest.size(); i++) {
                    View v = createInterestChip(chatProfileActivity, selectedInterest.get(i));
...
//        }
    ...
    private void setFirstimage(String imageUrl) {
        ...
        Glide.with(chatProfileActivity).load(imageUrl)
    ...
    private void instaFeedWs(String userId, String accessToken) {
        ...
        new CallNetworkRequest().getResponse(chatProfileActivity, false, "userChatMsgList", AppContants.AUTH_VALUE, url,
                    ...
                    public void onSuccess(String response) {
                        try {
                            ...
                            if (instagramMediaResponse != null) {
                                InstaFeedAdapter myPhotosAdapter = new InstaFeedAdapter(chatProfileActivity, instagramMediaResponse.getData());
                                rvInstaFeed.setLayoutManager(new GridLayoutManager(chatProfileActivity, 3));
...
//    @BindView(R.id.rvEventsAttending)
//    RecyclerView rvEventsAttending;
//    Unbinder unbinder;
//    private View rootView;
//    private UserDetailsItem userDetailsItem;
//
...
//    }
//
////    public static com.quirktastic.dashboard.profile.ViewProfileFragment newInstance() {
////
////        com.quirktastic.dashboard.profile.ViewProfileFragment f = new com.quirktastic.dashboard.profile.ViewProfileFragment();
////        return f;
////    }
//
//
...
//    public View onCreateView(LayoutInflater inflater, ViewGroup container,
//                             Bundle savedInstanceState) {
//        rootView = inflater.inflate(R.layout.fragment_chat_profile, container, false);
//        // Inflate the layout for this fragment
...
//
//                if (userDetailsItem.getHeaderBio() != null && userDetailsItem.getHeaderBio().length() > 0) {
//                    tvDescription.setText(userDetailsItem.getHeaderBio());
//                }
//                setGender(userDetailsItem.getGender());
//                setEthenity(userDetailsItem.getIdentity());
//                setInterests(userDetailsItem.getInterest());
//
//                if (userDetailsItem.getPersonalityText() != null && userDetailsItem.getPersonalityText().length() > 0) {
//                    tvFriendDesc.setText(userDetailsItem.getPersonalityText());
//                }
//
//                if (userDetailsItem.getInterestsText() != null && userDetailsItem.getInterestsText().length() > 0) {
//                    tvMutualInterest.setText(userDetailsItem.getInterestsText());
//                }
//
//                setUpImages(userDetailsItem);
//                setSocialList(userDetailsItem);
...
//            }
//
//            rvEventsAttending.setLayoutManager(new GridLayoutManager(getActivity(), 3));
//            rvEventsAttending.setAdapter(new EventListForViewAdapter(getActivity(), selectedEvents));
//        }
//    }
//
//    private void setSocialList(UserDetailsItem userDetailsItem) {
//        if (userDetailsItem.getSocialLife() != null && userDetailsItem.getSocialLife().size() > 0) {
//            rvSocialDrink.setLayoutManager(new GridLayoutManager(getActivity(), 3));
//            rvSocialDrink.setAdapter(new SocialLifeListForViewAdapter(getActivity(), userDetailsItem.getSocialLife()));
//        }
//    }
//
//    private void setInterests(ArrayList<InterestItem> interest) {
...
//            rvInterest.setAdapter(new InterestListForViewAdapter(getActivity(), selectedInterest));
//        }
//    }
//
//    private void setEthenity(ArrayList<IdentityItem> identity) {
...
//
//            if (gender.equalsIgnoreCase(GENDER_MAN)) {
//                tvGender.setText(getActivity().getString(R.string.man));
//            } else if (gender.equalsIgnoreCase(GENDER_WOMAN)) {
//                tvGender.setText(getActivity().getString(R.string.women));
//            } else if (gender.equalsIgnoreCase(GENDER_NON_BINARY)) {
//                tvGender.setText(getActivity().getString(R.string.non_binary));
//            }
//        }
//    }
//
