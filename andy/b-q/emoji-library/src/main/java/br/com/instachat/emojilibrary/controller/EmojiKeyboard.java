...
public class EmojiKeyboard implements OnEmojiClickListener {
    ...
    // CONSTRUCTOR
    public EmojiKeyboard(EmojiCompatActivity activity, View view ,EmojiEditText input) {
        this.mInput = input;
        this.mActivity = activity;
        this.view=view;
        this.mEmojiKeyboardLayout = (RelativeLayout) view.findViewById(R.id.emoji_keyboard);
    ...
    private void initEmojiKeyboardViewPager() {
        ...
        final ViewPager viewPager = (ViewPager) view.findViewById(R.id.emoji_viewpager);
        viewPager.setAdapter(adapter);

        final SmartTabLayout viewPagerTab = (SmartTabLayout) view.findViewById(R.id.emoji_tabs);
    ...
    private void setBackspaceBehaviour() {
        this.mBackspace = (ImageView) view.findViewById(R.id.backspace);
