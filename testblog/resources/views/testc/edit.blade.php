...
<tr>		 @if(count($errors))
		...
		@endif
                <td colspan="1">
                	{{ Form::model( $customer, ['url' => ['test/update',$customer->id], 'method' => 'put', 'role' => 'form','enctype'=>'multipart/form-data','class' => 'well form-horizontal'] ) }}
<!-- <form method="post" action="{{ url('test') }}" enctype="mutipart/form-data"> -->
