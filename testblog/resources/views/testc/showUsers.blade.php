...
<body>
	...
	<!--END SEARCH BAR -->
		<div class="form-group col-md-6">
			<a class="btn btn-success" style="float: right;" href="{{ url('test/create') }}"> Add User </a>
				...
				<table class="table">
					...
					<tr>
						...
						<td>
						 ...
						 <td>
							<a href="{{ url('test/show',$data->id) }}"" class="btn btn-sm btn-success">View<span class="glyphicon glyphicon-eye-open"></span></a>
						</td>

						<td>
							<a href="{{ url('test/edit',$data->id) }} " class="btn btn-sm btn-info">Edit<span class="glyphicon glyphicon-pencil"></span></a>
						</td>  

						<td>
							<form action="{{url('test/delete', $data->id)}}" method="post" onsubmit="return confirm('Are you sure?');"  style="display: inline">
				           	{{csrf_field()}}
